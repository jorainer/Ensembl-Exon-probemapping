...
for the Affymetrix Human Gene ST microarray. The CDF file/package
...
save( annot, file=paste( "annotation/annot_hugene_genelevel_",
               ENSEMBL_VERSION,
               ".Rdata",sep="" ) )
