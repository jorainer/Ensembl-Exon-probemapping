...
for the Affymetrix Mouse Gene ST microarray containing also intronic probe sets. The CDF file/package
...
save( annot, file=paste( "annotation/annot_mouse_gene_ginex_",
               ENSEMBL_VERSION,
               ".Rdata",sep="" ) )
