...
for the Affymetrix Human Exon 1.0 ST microarray containing also intronic probe sets. The CDF file/package
...
save( annot, file=paste( "annotation/annot_human_exon_ginex_",
               ENSEMBL_VERSION,
               ".Rdata",sep="" ) )
